...
int main() {
	...
	realTest.push_front(1.2);
	realTest.push_front(2.4);
	realTest.push_front(3.6);
	realTest.push_back(100.100);
	assert(realTest.pop_back() == 1.2);
	assert(realTest.pop_front() == 2.4);
	assert(realTest.pop_front() == 3.6);
	...
	compTest.push_back(100.100);
	assert(compTest.pop_back() == std::complex<double>(1,2));
	assert(compTest.pop_front() == std::complex<double>(3,4));
	assert(compTest.pop_front() == std::complex<double>(5,6));
	assert(compTest.pop_front() == std::complex<double>(7,8));
	...
	assert(personTest.pop_back() == Person({1,2}, "Avery", "Lee", "Ivanovich"));
